<%@ Page Title="" Language="C#" MasterPageFile="~/tasarim.master" AutoEventWireup="true" CodeFile="kategori.aspx.cs" Inherits="kategori" %>
<script runat="server">
...
<h1><asp:Label ID="kad" runat="server"></asp:Label></h1>
             <h2>  <asp:Label CssClass="kaciklama" ID="aciklama" runat="server"></asp:Label>, <%#Eval("isapi") %> kategorisinde oyun oynamak için oyunde doğru adres,Oyun oynamak sizler için yararlıdır.</h2>
