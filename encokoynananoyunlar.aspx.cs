...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        Page.Title = "En Çok Oynanan Oyunlar | Oyun De";
        using(baglanti = new MySqlConnection(bag))
        {
            try
            {
                ...
                //anasayfa oyun1
                MySqlCommand o1 = new MySqlCommand("select id,adi,resim,hit from oyunlar where onay='1' order by hit desc limit 20;", baglanti);
