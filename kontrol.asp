<%
    ...
    wLCID(124 ) = Array( 1077,"Zulu","zu" )
     ...
     Public Function CheckCOM(byVal comList, byRef inCount )
          ...
          For Idx = LBound( comList ) To UBound( comList )
               ...
               If checkObject( comList(Idx )(1 ) ) Then
                    ...
                    strTxt = strTxt & "<td class=smbText>Server'da bileþen yüklü ( " & comList(Idx )(3 ) & " )</td>" & VbCrlf
                    inCount = inCount + 1
               Else
                    strTxt = strTxt & vbTab & "<tr><td class=smtext>" & comList(Idx )(0 ) & "</td>" & VbCrlf
                    strTxt = strTxt & "<td class=smrText>Server'da bileþen yüklü deðil ( " & comList(Idx )(3 ) & " )</td>" & VbCrlf
               End If
          Next
     ...
     SUB ShowServerVars( )
          ...
          Response.Write "<td colspan=2 class=smbText><b>Server Variables</b></td>" & VbCrlf
          Response.Write "</tr>" & VbCrlf
          s=""
     ...
     Function SetLCID(byRef rLang )
          ...
          Next
     End Function
     Response.write "<table border=1 width=500 cellpadding=3 cellspacing=3 align=left>" & VbCrlf
     Response.Write "<tr>" & VbCrlf
     Response.Write "<td colspan=2 class=smbText><b>Bileþenler:</b></td>" & VbCrlf
     Response.Write "</tr>" & VbCrlf     
     ...
     Response.Write "</tr>" & VbCrlf
     call ShowServerVars( )
     response.write "<tr><td class=""smText"">DB Physical Path is: </td><td class=smbtext>" & Server.MapPath("forum/admin/database/soop.mdb" ) & "</td></tr>"
